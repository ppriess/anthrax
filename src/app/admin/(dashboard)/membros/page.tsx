      ...
      <form action={saveMembrosIntro} className="flex max-w-xl flex-col gap-4">
        ...
        <label className="flex flex-col gap-1">
          <span className="font-mono text-xs text-on-dark-3">
            Foto de grupo (caminho/URL, opcional — ex.:
            /albums/photos/anthrax-2026-press-july.jpg)
          </span>
          <input
            name="photo"
            defaultValue={membros.photo}
            className="admin-input"
          />
        </label>
        <label className="flex flex-col gap-1">
          <span className="font-mono text-xs text-on-dark-3">
            Crédito da foto (opcional, ex.: Foto: Travis Shinn)
          </span>
          <input
            name="photoCredit"
            defaultValue={membros.photoCredit}
            className="admin-input"
          />
        </label>
        <button
